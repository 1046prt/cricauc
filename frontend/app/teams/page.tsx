    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-12">
        <div className="flex justify-between items-center mb-8 flex-wrap gap-4">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-2">My Teams</h1>
            <p className="text-xl text-gray-600">Manage and view all your cricket teams</p>
          </div>
          <Link
            href="/teams/create"
        ...
        {teams.length > 0 ? (
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600">{team.league?.name || 'No league'}</p>
                    </div>
                  ...
                  <div className="pt-4 border-t space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-2xl font-bold text-green-600">
                        ₹{((team.purse || 0) - (team.spent || 0)).toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">Players:</span>
                      <span className="font-semibold text-gray-900">{team.playerCount || 0}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">Total Purse:</span>
                      <span className="font-semibold text-gray-700">₹{(team.purse || 0).toLocaleString()}</span>
                    </div>
                  </div>
                </div>
              </Link>
          ...
          <div className="bg-white rounded-xl shadow-lg p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">Create your first team to start participating in auctions!</p>
            <Link
              href="/teams/create"
